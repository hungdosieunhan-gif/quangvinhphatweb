(() => {
    ...
    r.m = e, (() => {
        ...
        r.t = function(n, o) {
            ...
            e = e || [null, t({}), t([]), t(t)];
            for (var c = 2 & o && n;
                "object" == typeof c && !~e.indexOf(c); c = t(c)) Object.getOwnPropertyNames(c).forEach(e => {
                a[e] = () => n[e]
            });
        ...
        r.l = function(t, n, o, i) {
            ...
            if (void 0 !== o)
                for (var a, c, l = document.getElementsByTagName("script"), d = 0; d < l.length; d++) {
                    var s = l[d];
            ...
            a || (c = !0, (a = document.createElement("script")).charset = "utf-8", a.timeout = 120, r.nc && a.setAttribute("nonce", r.nc), a.src = t), e[t] = [n];
            var b = function(r, n) {
